...
class ClothingTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.clothLabel.text = clothing.brand
    ...
    */
    ...
    private func loadSampleClothes() {
        ...
        guard let dress = Clothing(brand: "Cotton On", classification: 1, color: "Blue", id: 1, material: "Material1", status: 1, weather: 1, imageIcon: photo1) else {
            fatalError("Unable to instantiate dress")
        }
        
        guard let jacket = Clothing(brand: "Uniqlo", classification: 1, color: "Blue", id: 1, material: "Material1", status: 1, weather: 1, imageIcon: photo2) else {
            fatalError("Unable to instantiate jacket")
        }
        
        guard let sleeveless = Clothing(brand: "Ukay", classification: 1, color: "Blue", id: 1, material: "Material1", status: 1, weather: 1, imageIcon: photo3) else {
            fatalError("Unable to instantiate jacket")
        }
        
        guard let pants = Clothing(brand: "H&M", classification: 2, color: "Blue", id: 1, material: "Material1", status: 1, weather: 1, imageIcon: photo4) else {
            fatalError("Unable to instantiate pants")
        }
        clothes += [dress, jacket, sleeveless, pants]
    }
}
